...
public class AppConfig_second {
    ...
    public static LoadInterface getLoadInterface() {
        if (loadInterface == null)
            loadInterface = AppConfig_second.getClient().create(LoadInterface.class);
        return loadInterface;
    }

    public static LoadInterface api_Interface() {
        return AppConfig_second.getClient().create(LoadInterface.class);
    }
}
