...
public class SecondSubProductAdapter extends RecyclerView.Adapter<SecondSubProductAdapter.MyViewHolder> {

    Context context;
    List<ProductWithQuantity> CustomerLists;


    public SecondSubProductAdapter(Context context, List<ProductWithQuantity> customerList) {
    ...
    @Override
    public SecondSubProductAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.address_list_adapter, parent, false);
        return new SecondSubProductAdapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(final SecondSubProductAdapter.MyViewHolder holder, final int position) {
